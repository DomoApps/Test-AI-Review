...
<img class="alignnone size-full" src="https://web-assets.domo.com/miyagi/images/product/product-feature-appstore-overview-all-apps-2x.png" width="1056" height="848" />
...
<ul>
 	<li>App should clearly answer a business question</li>
 	<li>Business question needs to be stated in the collection title along with a description (Card Builder)</li>
 	<li>Text should be clear, concise, professional, and error free</li>
 	<li>No pornographic images or use of offensive or violent language</li>
 	<li>No capturing or storing personal identifiable information from app users</li>
</ul>

### Data
<em>Datasets that are pulled through Domo connectors or manually provided in a webform must adhere to Domo's standards. Datasets using DataFlows and Beast Modes must also follow the requirements listed below:</em>
<h4><strong>Required</strong></h4>
...
<ul>
 	<li>Webforms containing sample data should not exceed 1,000 rows</li>
 	<li>DataFlows, if used, should include a detailed description</li>
 	<li>DataFlows, if used, should use SQL comments to aid in understanding intentions</li>
</ul>
...
<ul>
 	...
 	<li>Set cookies with the HttpOnly attribute, unless you specifically require client-side scripts within your application to read or set a cookie's value</li>
</ul>
